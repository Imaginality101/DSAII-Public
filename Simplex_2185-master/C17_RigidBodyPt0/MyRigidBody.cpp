...
MyRigidBody::MyRigidBody(std::vector<vector3> a_pointList)
{
	...
	//m_v3Center = m_v3Center / static_cast<float>(uPointCount);   // circle

	m_v3Center = (m_v3MaxL + m_v3MinL) / 2.0f;    // rectangle
...
void MyRigidBody::AddToRenderList(void)
{
	...
	m_pMeshMngr->AddWireCubeToRenderList(glm::translate(m_m4ToWorld, m_v3Center) * glm::scale(m_v3HalfWidth * 2), m_v3Color, RENDER_WIRE);
}
